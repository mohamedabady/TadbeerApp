    ...
    const body = (
      <React.Fragment>
        <View style={[styles.fullTrack, { width: sliderLength }]}>
          {this.props.isMarkersSeparated ? <View
            style={[
              styles.track,
          ...
          /> : <LinearGradient
              start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#463795', '#D9A0AF']}
              style={[
                styles.track,
                this.props.trackStyle,
                trackOneStyle,
                { width: trackOneLength, height: 30, marginVertical: -15, borderTopLeftRadius:15, borderBottomLeftRadius:15 },
              ]}
            />}

          {this.props.isMarkersSeparated ? <LinearGradient
            start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#463795', '#D9A0AF']}
            style={[
              styles.track,
              this.props.trackStyle,
              trackTwoStyle,
              { width: trackTwoLength, height: 30, marginVertical: -15 },
            ]}
